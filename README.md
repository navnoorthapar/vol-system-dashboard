...
14 components, ~15,300 lines of Python (ex-tests), **631 passing tests**, zero look-ahead bias.
...
# 631 passed locally (with trained NN weights present)
# 613 passed, 18 skipped on a clean clone — the NN-pricer tests need the
